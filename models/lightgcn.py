...
class LightGCN(nn.Module):
    ...
    def propagate(self, adj, user_emb, item_emb):
        ...
        mean_embeddings = torch.mean(stack_embeddings, dim=1)
        u_g_embeddings, i_g_embeddings = torch.split(mean_embeddings, [self.n_users, self.n_items], dim=0)

        return u_g_embeddings, i_g_embeddings, all_embeddings, mean_embeddings
