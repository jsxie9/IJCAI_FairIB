...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_path', type=str, default='logs/ib_bpr_fm_')
    parser.add_argument('--param_path', type=str, default='param/ib_bpr_item_fm_')
    parser.add_argument('--pretrain_path', type=str, default='param/_base.pth')
    parser.add_argument('--num_epochs', type=int, default=1000)
    parser.add_argument('--device', type=str, default='cuda:1')
    parser.add_argument('--beta', type=float, default=2)
    parser.add_argument('--gamma', type=float, default=1)
    parser.add_argument('--sigma', type=float, default=0.4, help='gaosi kernel parameter')
